...
const FacialRecognition = dynamic(() => import('@/components/facial-recognition'), { 
  ssr: false,
  loading: () => <div>Loading...</div>
})
const TimeTracking = dynamic(() => import('@/components/time-tracking'), { 
  ssr: false,
  loading: () => <div>Loading...</div>
})
...
const AttendanceTable = dynamic(() => import('@/components/attendance-table'), { 
  ssr: false,
  loading: () => <div>Loading...</div>
})
const ReportsExport = dynamic(() => import('@/components/reports-export'), { 
  ssr: false,
  loading: () => <div>Loading...</div>
})
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-background/50 p-4 md:p-6">
          ...
          >
            <TabsList className="w-full justify-start overflow-x-auto bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-background/60">
